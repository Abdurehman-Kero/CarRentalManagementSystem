...
const InsuranceManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(e?.error || "Failed to save insurance");
    } finally {
      setSubmitting(false);
    }
  };
  ...
  const doDelete = async () => {
    ...
    try {
      ...
      toast.error(e?.error || "Failed to delete insurance");
    }
  };
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            {insurances.length} available plan
        ...
        {filtered.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
            {filtered.map((i) => (
              <div
                key={i.InsuranceID}
                className="card p-5 hover:border-primary-200 hover:shadow-lg transition-all relative group"
              >
                <div className="flex items-center gap-4 mb-4">
                  <div
                    className={`w-12 h-12 rounded-2xl flex items-center justify-center text-white text-xl font-bold flex-shrink-0 bg-gradient-to-br ${getGradient(i.InsuranceID)}`}
                  >
                ...
                <div className="mt-auto pt-4 border-t border-surface-200 flex items-end justify-between">
                  <div>
                    <p className="text-xs text-surface-500 font-medium uppercase tracking-wider mb-1">
                      Fixed Cost
                    </p>
                  ...
                  <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button
                      ...
                      className="btn-icon bg-surface-100 hover:bg-surface-200 text-surface-600 w-8 h-8"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
                    ...
                    <button
                      ...
                      className="btn-icon bg-danger-50 hover:bg-danger-100 text-danger-500 w-8 h-8"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
              ...
              <div className="modal-body space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(ev) => set("InsuranceType", ev.target.value)}
                    required
                  />
                </div>
                <div>
